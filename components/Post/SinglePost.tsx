...
const SinglePost = (props: Props) => {
  ...
  return (
    <>
      {isPaginationPage ? (
        <section className="h-64 bg-sky-900 mb-8 mx-auto rounded-md p-5 shadow-2xl hover:shadow-none hover:translate-y-1 transition-all duration-300 sp:text-base">
